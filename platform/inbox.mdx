...
For the shared WhatsApp inbox surface itself (list threads, reply, webhooks, what is console-only), start at [Inbox](/guides/inbox). This page is the **platform** recipe on top of that API.
